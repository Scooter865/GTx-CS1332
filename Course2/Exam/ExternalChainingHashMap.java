...
public class ExternalChainingHashMap<K, V> {
    ...
    public V get(K key) {
        ...
        while (cur != null) {
            // Return the value when you've found the key
            if (cur.getKey().equals(key)) { 
                return cur.getValue();
            }

            // Move down the chain if key isn't found
            cur = cur.getNext();
        }
        
        // Throw exception if you searched the entire chain and didn't find the key
