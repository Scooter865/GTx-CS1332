...
public class boyerMooreTests 
{
    ...
    public void OneOccurrence() {
        ...
        assertEquals(expected, PatternMatching.boyerMoore(pattern, text, testCharacterComparator));
    }
    ...
    public void NoOccurrence() {
        ...
        assertEquals(expected, PatternMatching.boyerMoore(pattern, text, testCharacterComparator));
        assertTrue(PatternMatching.boyerMoore(pattern, text, testCharacterComparator).isEmpty());
    }
