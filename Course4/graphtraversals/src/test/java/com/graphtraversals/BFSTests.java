...
public class BFSTests 
{
    ...
    */
    ...
    public void SmallGraphTest() {
        ...
        assertEquals(answer, GraphAlgorithms.bfs(A, testGraph));
    }
    ...
    public void RandomGraphTest() {
        ...
        answer.addAll(Arrays.asList(B, A, G, C, D, E, F, H));

        assertEquals(answer, GraphAlgorithms.bfs(B, testGraph));
        
        // Build answer list for BFS starting at G
        answer.clear();
        answer.addAll(Arrays.asList(G, B, E, F, H, A, D, C));

        assertEquals(answer, GraphAlgorithms.bfs(G, testGraph));
    }
