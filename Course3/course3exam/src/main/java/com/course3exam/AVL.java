...
public class AVL<T extends Comparable<? super T>> {
    ...
    public AVLNode<T> rotateLeft(AVLNode<T> currentNode) {
        AVLNode<T> nodePtr = currentNode.getRight();

        currentNode.setRight(nodePtr.getLeft());
        nodePtr.setLeft(currentNode);

        updateHeightAndBF(currentNode);
        updateHeightAndBF(nodePtr);
    ...
    public AVLNode<T> rotateRight(AVLNode<T> currentNode) {
        AVLNode<T> nodePtr = currentNode.getLeft();

        currentNode.setLeft(nodePtr.getRight());
        nodePtr.setRight(currentNode);
